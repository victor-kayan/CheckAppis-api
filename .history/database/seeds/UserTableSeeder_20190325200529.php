...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $apicultor1->foto = 'https://192.168.200.223/storage/images/user1.jpg';
        $apicultor1->save();
        ...
        $apicultor2->foto = 'https://192.168.200.223/storage/images/user1.jpg';
        $apicultor2->save();
        ...
        $apicultor3->foto = 'https://192.168.200.223/storage/images/user1.jpg';
        $apicultor3->save();
        ...
        $tecnico->foto = 'https://192.168.200.223/storage/images/user1.jpg';
        $tecnico->save();
