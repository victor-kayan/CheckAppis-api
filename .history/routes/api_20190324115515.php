...
Route::middleware('auth:api')->namespace('Api')->group(function () {
    ...
    Route::get('intervencao/apiario/apiario/{id}', 'IntervencaoController@indexByApiario');

    Route::get('intervencao/colmeia/intervencao/{id}', 'IntervencaoColmeiaController@indexByIntervencao');
