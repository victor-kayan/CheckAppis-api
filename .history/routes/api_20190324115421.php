...
Route::middleware('auth:api')->namespace('Api')->group(function () {
    ...
    Rute::get('intervencao/apiario/apiario/{id}', 'IntervencaoController@indexByApiario'):

    Rute::get('intervencao/colmeia/intervencao/{id}', 'IntervencaoColmeiaController@indexByIntervencao'):
