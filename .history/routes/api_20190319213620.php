...
Route::prefix('auth')->group(function () {
    ...
    Route::post('login/apicultor', 'AutenticadorControlador@loginApicultor')->middleware('role:apicultor');
    Route::post('login/tecnico', 'AutenticadorControlador@loginTecnico')->middleware('role:tecnico');
