...
class ColmeiaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->colmeia->foto = $this->colmeia->uploadImage($request, $this->colmeia);
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->colmeia = $this->colmeia::update($request->all());

        return $this->colmeia->uploadImage($request, $this->colmeia->id);
