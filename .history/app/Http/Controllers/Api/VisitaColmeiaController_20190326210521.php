...
class VisitaColmeiaController extends Controller
{
    ...
    public function visitasColmeiasByVisitaApiario($visita_apiario_id) {

        $visitas = $this->visitaColmeia->where('visita_apiario_id', $visita_apiario_id)->with('colmeia')->get();

        return response()->json([
            'message' => 'Lista de visitasColmeias',
            'visitas' => $visitas,
        ]);
    }
