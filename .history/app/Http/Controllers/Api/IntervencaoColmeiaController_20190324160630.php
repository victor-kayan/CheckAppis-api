...
class IntervencaoColmeiaController extends Controller
{
    ...
    public function indexByIntervencao($intervencao_id){
        $intervencoes = IntervencaoColmeia::where('intervencao_id', $intervencao_id)->where('is_concluido', true)->with('colmeia')->orderBy('created_at', 'ASC')->get();
    ...
    public function concluirIntervencao($intervencao_id){
        ...
        $this->intervencao = $this->intervencao->findOrFail($intervencao_id);
