...
class ApiarioController extends Controller
{
    ...
    public function __construct(Apiario $apiario)
    {
        ...
        $this->middleware('role:tecnico', ['except' => ['apiariosUserLogado', 'apiarioColmeias']]);
    }
    ...
    public function apiariosUserLogado () {
        ...
        $this->apiario = $this->apiario->where('user_id', auth()->user()->id)->get();
    ...
    public function apiarioColmeias($id){
        ...
        $colmeias = Colmeia::findOrFail($id);
