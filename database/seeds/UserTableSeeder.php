...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $apicultor1->foto = 'http://192.168.200.253/storage/images/user1.jpg';
        $apicultor1->save();
        ...
        $apicultor2->foto = 'http://192.168.200.253/storage/images/user1.jpg';
        $apicultor2->save();
        ...
        $apicultor3->foto = 'http://192.168.200.253/storage/images/user1.jpg';
        $apicultor3->save();
        ...
        $tecnico->foto = 'http://192.168.200.253/storage/images/user1.jpg';
        $tecnico->save();
